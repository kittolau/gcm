<?php
$this->pageTitle = "Bookmark作品列表 - 會員中心 - ";
?>
<ol class="breadcrumb">
    <li class="active"> <span class="glyphicon glyphicon-chevron-down"></span> Bookmark作品列表</li>
</ol>
...
<?php $this->widget('zii.widgets.CListView', array(
	'dataProvider'=>$model->showOnlyIllustId($user->getBookmarkedIllustId())->search(),
        'emptyText'=>'沒有相關作品',
