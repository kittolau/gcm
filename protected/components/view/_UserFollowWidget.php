<?php $form=$this->beginWidget('CActiveForm', array(
                'action'=>Yii::app()->createUrl('user/followUser'),
                'method'=>'post'
            )); ?>
     
    <div class="col-xs-12 btn-group-vertical btn-group-sm">
        <?php if($isSelfViewing || $notLogedIn){?>
            <a class="btn btn-primary btn-block" href="#"><i class="glyphicon glyphicon-thumbs-up"></i>人氣<span class="badge"><?php echo $user->getFollowedCount() ?></span></a>
        <?php }else{ ?>
