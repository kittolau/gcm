...
/**
 * a custom version of CUserIdentity that orverride the original login logic
 * instead of using normal password to login, Using this class will let you be able to log on a user by using it's hashed password
 */
class MD5LoginUserIdentity extends CUserIdentity
{
	/**
